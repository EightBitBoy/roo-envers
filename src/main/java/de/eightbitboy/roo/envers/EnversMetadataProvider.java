...
/**
 * Provides {@link EnversMetadata}. This type is called by Roo to retrieve the metadata for this add-on.
...
public final class EnversMetadataProvider extends AbstractItdMetadataProvider {
    ...
    protected void activate(ComponentContext context) {
        ...
        addMetadataTrigger(new JavaType(RooEnvers.class.getName()));
    }
    ...
    protected void deactivate(ComponentContext context) {
        ...
        removeMetadataTrigger(new JavaType(RooEnvers.class.getName()));    
    }
    ...
    /**
     * Define the unique ITD file name extension, here the resulting file name will be **_ROO_Envers.aj
     */
    ...
    protected String getGovernorPhysicalTypeIdentifier(String metadataIdentificationString) {
        JavaType javaType = EnversMetadata.getJavaType(metadataIdentificationString);
        LogicalPath path = EnversMetadata.getPath(metadataIdentificationString);
        return PhysicalTypeIdentifier.createIdentifier(javaType, path);
    }
    
    protected String createLocalIdentifier(JavaType javaType, LogicalPath path) {
        return EnversMetadata.createIdentifier(javaType, path);
    }

    public String getProvidesType() {
        return EnversMetadata.getMetadataIdentiferType();
    }
}